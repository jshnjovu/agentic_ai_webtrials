...
async def get_alerts(
    ...
    hours: Optional[int] = Query(24, description="Only return alerts from the last N hours")
):
    """
...
async def get_api_alerts(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get API alerts: {str(e)}")
